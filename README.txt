...
Srinidhi Raghavendra (sraghav2@binghamton.edu) - complete functionality
State University of New York, Binghamton

Notes:
----------------------------------------------------------------------------------
1) This codes implements a simulator for the simulation of a processor which supports speculative execution.
2) The specifications of the processor in mentioned in the ProblemStatement.txt file.
File-Info
----------------------------------------------------------------------------------
